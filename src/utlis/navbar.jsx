...
const Navbar = () => {
  ...
  return (
    ...
    <nav class="bg-white border-gray-200 dark:bg-teal-950">
        ...
        <div className={`w-full md:block md:w-auto ${isMenuOpen ? 'block' : 'hidden'}`}>
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-teal-950 md:dark:bg-teal-950 dark:border-gray-700">
            ...
            <li className="md:hidden mt-2">
                <a href="#" className="block w-full text-center bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700">Get Started</a>
              </li>
          </ul>
        </div>
      </div>
